...
func (b *EthAPIBackend) GetBatchEVM(ctx context.Context, msg core.Message, index int, state *state.StateDB, header *types.Header, vmConfig *vm.Config) (*vm.EVM, func() error, error) {
	if vmConfig == nil {
